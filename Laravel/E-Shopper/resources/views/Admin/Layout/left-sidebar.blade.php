    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/profile/{{Auth::id()}}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/shopee-blog" aria-expanded="false">
                        <i class="mdi mdi-arrange-bring-forward"></i>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/brand" aria-expanded="false">
                        <i class="mdi mdi-arrange-bring-forward"></i>
